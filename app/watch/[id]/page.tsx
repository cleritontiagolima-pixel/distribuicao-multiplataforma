...
export default function WatchPage() {
    ...
    async function loadVideo() {
      ...
      try {
        const [detailsRes, relatedRes] = await Promise.all([
          ...
          fetch(`/api/videos/${videoId}?type=related`),
        ]);
  ...
  useEffect(() => {
    ...
    navigator.mediaSession.setActionHandler("previoustrack", () => {
      // Go to previous video or rewind
    });
                      ...
                      <>
                        ...
                        {playlists.length > 0 && (
                          <div className="relative group">
                            ...
                            <div className="absolute top-full right-0 mt-1 w-56 rounded-xl border border-[var(--border)] py-2 shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50"
              ...
              {loading ? (
                ...
                relatedVideos.map((rv) => (
                  <VideoCard
                    ...
                    id={rv.id}
                    title={rv.title}
                    thumbnail={rv.thumbnail || `https://i.ytimg.com/vi/${rv.id}/hqdefault.jpg`}
